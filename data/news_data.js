window.NEWS_DATA = {
 ...
 "articles": [
  ...
  {
   "section": "בידור",
   "title": "משקאות זיעה, חביתות קיא וצואה במרומים: הקטעים הכי מגעילים של ג'קאס",
   "summary": "כבר יותר מ-25 שנה שחבורת הדגנרטים של ג'קאס מתעללת בעצמה בשם האמנות. או בשם... משהו. אבל גם אם הם הקשישו, וגם אם ייתכן שזה כבר הסוף, שמחת החיים של החבורה טרם פגה - ולכבודה אספנו עבורכם את הקטעים הדוחים, המבחילים, המגעילים וההיסטריים ביותר שהופיעו בזיכיון הזה, ב…",
   "source": "ynet - תרבות ובידור",
