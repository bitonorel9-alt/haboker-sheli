window.NEWS_DATA = {
 ...
 "articles": [
  ...
  {
   "section": "בידור",
   "title": "גל גדות מגינה על השימוש ב-AI בסרטה החדש: \"או שתעבדו איתו - או שתצאו מהמשחק\"",
   "summary": "גדות מככבת בסרט שגרר ביקורת בעקבות שימוש בבינה מלאכותית ליצירת התפאורה והתאורה, מה שלטענת המפיק חסך להפקה יותר מ-200 מיליון דולר. לדבריה, עורכי דינה הקדישו חצי שנה לעבודה על החוזה כדי להגן על הופעתה משינוי באמצעות AI. עוד מתחה ביקורת על האופן שבו טיפלו אולפני …",
   "source": "ynet - תרבות ובידור",
   "link": "https://www.ynet.co.il/entertainment/article/s1jkuk4dfx",
   "image": "https://ynet-pic1.yit.co.il/picserver6/crop_images/2026/04/14/Hyaaf0jnWe/Hyaaf0jnWe_871_125_1218_685_0_medium.jpg",
   "stats": [
    [
     "מקור",
     "ynet - תרבות ובידור"
