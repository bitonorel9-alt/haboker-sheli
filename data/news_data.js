window.NEWS_DATA = {
 ...
 "articles": [
  ...
  },
  {
   ...
   "link": "https://www.ynet.co.il/entertainment/article/sjuoe84uml",
   "image": "https://ynet-pic1.yit.co.il/picserver6/crop_images/2026/08/31/ryky0RfuMx/ryky0RfuMx_0_0_2275_1517_0_medium.jpg",
   "stats": [
    [
     "מקור",
     "ynet - תרבות ובידור"
  ...
  {
   "section": "בידור",
   "title": "המותחן הבינוני הזה הוא הדבר האחרון שהקריירה של גל גדות צריכה כרגע",
   "summary": "בסרט \"במרוץ כנגד הזמן\" גדות יוצאת לריצת בוקר בלונדון ומגלה שבנה נחטף, וכי לרשותה שעה אחת בלבד לבצע פשע שיציל את חייו. מדובר בסרט לא לגמרי משעמם בזכות הקצב המהיר והאורך הקצר, אך העלילה המופרכת, התסריט הדל, ועומס האפקטים הופכים אותו ללא-יותר ממותחן סטרימינג גנרי",
   "source": "ynet - תרבות ובידור",
