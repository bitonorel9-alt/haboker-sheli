window.NEWS_DATA = {
 ...
 "lead": {
  ...
  "title": "טראמפ: ארה\"ב שולטת ביטחונית בגרינלנד",
  "summary": "הנשיא טראמפ הודיע על הסכם היסטורי - והכריז על שליטה מלאה באי שעד כה היה בשליטת דנמרק. לדבריו, מדינה שתרצה לפעול בגרינלנד תידרש לאישור רשמי בכתב מארה\"ב. \"נגן על השטח בקנאות\", כתב טראמפ. דנמרק: נחתום על ההסכם בעצרת האו\"ם",
 ...
 "articles": [
  {
   ...
   "summary": "כרגע 24.2°, לחות 89%, רוח 3.1 קמ״ש. סיכוי משקעים 43%.",
  ...
  {
   "section": "פוליטיקה",
   "title": "נחשף \"המושבע הבודד\" במשפט חונקת ילדיה שהסעיר את ארה\"ב: \"היא תכננה את זה\"",
   "summary": "11 מ-12 המושבעים במשפט של לינדזי קלנסי התכוונו לזכותה מרצח שלושת ילדיה הקטנים כי הייתה בפסיכוזה לאחר לידה. אבל מייקל דסרונוויל חשב אחרת, והמשפט הסתיים ללא הכרעה: \"לא היו לי שום ספקות, היא ידעה בדיוק מה היא עושה\". עורך דינו, שייצג בעבר את טראמפ: \"הוא גיבור אמרי…",
   "source": "ynet - חדשות",
   "link": "https://www.ynet.co.il/news/article/hkqbfzskzl",
