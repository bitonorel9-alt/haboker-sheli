window.NEWS_DATA = {
 ...
 "articles": [
  ...
  {
   "section": "בידור",
   "title": "ספר חדש מבוסס לכאורה על דמותה של נטלי פורטמן - ומתואר כ\"דיוקן אפל\" שלה",
   "summary": "על פי דיווחים, ספרה החדש של הסופרת רייצ'ל קאסק, Life of M - שבמרכזו שחקנית זוהרת וסופרת שמתלווה אליה כדי לתעד את חייה - מבוסס על חייה של פורטמן, שנחשבת דווקא מעריצה של כתביה של קאסק",
   "source": "ynet - תרבות ובידור",
   "link": "https://www.ynet.co.il/entertainment/article/sylat194gl",
   "image": "https://ynet-pic1.yit.co.il/picserver6/crop_images/2026/06/22/B1Hosn8Gzg/B1Hosn8Gzg_0_148_3000_1688_0_medium.jpg",
   "stats": [
    [
     "מקור",
     "ynet - תרבות ובידור"
  ...
  {
   "section": "בידור",
   "title": "הופעתו של באד באני במילאנו בוטלה בעקבות סופת ברד - 80 אלף צופים פונו",
   "summary": "הופעתו של הכוכב הופסקה והקהל נאלץ להתפנות ממתחם ההופעות הפתוח. מספר צופים נפגעו בראשם מאבני ברד גדולות וקיבלו טיפול רפואי במקום",
   "source": "ynet - תרבות ובידור",
