window.NEWS_DATA = {
 ...
 "articles": [
  ...
  {
   "section": "בידור",
   "title": "איחולים בלתי סבירים לשנה הבאה / רענן שקד",
   "summary": "הצרה עם איחולי השנטובה הסטנדרטיים היא שאנחנו הולכים איתם בקטן מדי. הנה האיחולים הרצויים",
   "source": "ynet - תרבות ובידור",
